...
/*  70 */     this.ap = paramIMixinAnnotationProcessor;
/*  71 */     this.obfs = new ObfuscationDataProvider(paramIMixinAnnotationProcessor, this.environments);
/*  72 */     this.refs = new ReferenceManager(paramIMixinAnnotationProcessor, this.environments);
/*     */   }
/*     */ 
/*     */   
/*     */   public void init() {
...
/*  82 */     for (ObfuscationType obfuscationType : ObfuscationType.types()) {
/*  83 */       if (obfuscationType.isSupported()) {
/*  84 */         this.environments.add(obfuscationType.createEnvironment());
/*     */       }
/*     */     } 
/*     */   }
/*     */ 
...
/* 116 */     for (ObfuscationEnvironment obfuscationEnvironment : this.environments) {
/* 117 */       obfuscationEnvironment.writeMappings(this.consumers);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              C:\Users\homy\AppData\Roaming\.minecraft\mods\FogClientV1_cracked.jar!\org\spongepowered\tools\obfuscation\ObfuscationManager.class
