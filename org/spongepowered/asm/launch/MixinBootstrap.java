...
/*  99 */     if (platform == null) {
/* 100 */       MixinPlatformManager mixinPlatformManager = (MixinPlatformManager)GlobalProperties.get("mixin.platform");
/* 101 */       if (mixinPlatformManager instanceof MixinPlatformManager) {
/* 102 */         platform = mixinPlatformManager;
/*     */       } else {
...
/*     */       
/* 140 */       String str = System.getProperty("sun.java.command");
/* 141 */       if (str != null && str.contains("GradleStart")) {
/* 142 */         System.setProperty("mixin.env.remapRefMap", "true");
/*     */       }
/*     */       
/* 145 */       MixinEnvironment.Phase phase = MixinService.getService().getInitialPhase();
/* 146 */       if (phase == MixinEnvironment.Phase.DEFAULT) {
/* 147 */         logger.error("Initialising mixin subsystem after game pre-init phase! Some mixins may be skipped.");
/* 148 */         MixinEnvironment.init(phase);
/* 149 */         getPlatform().prepare(null);
/* 150 */         initState = false;
/*     */       } else {
/* 152 */         MixinEnvironment.init(phase);
/*     */       } 
/*     */       
...
/*     */     
/* 182 */     if (initState) {
/* 183 */       getPlatform().prepare(paramList);
...
/* 201 */     Object object = GlobalProperties.get("mixin.initialised");
/* 202 */     return (object != null) ? object : "";
/*     */   }
/*     */   
/*     */   private static void registerSubsystem(String paramString) {
/* 206 */     GlobalProperties.put("mixin.initialised", paramString);
/*     */   }
/*     */ }


/* Location:              C:\Users\homy\AppData\Roaming\.minecraft\mods\FogClientV1_cracked.jar!\org\spongepowered\asm\launch\MixinBootstrap.class
