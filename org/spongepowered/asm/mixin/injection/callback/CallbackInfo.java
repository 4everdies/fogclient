...
/*  63 */     this.cancellable = paramBoolean;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 122 */     return (paramType.equals(Type.VOID_TYPE) ? CallbackInfo.class.getName() : CallbackInfoReturnable.class.getName()).replace('.', '/');
/*     */   }
/*     */   
/*     */   static String getConstructorDescriptor(Type paramType) {
/* 126 */     if (paramType.equals(Type.VOID_TYPE)) {
/* 127 */       return getConstructorDescriptor();
/*     */     }
/*     */     
/* 130 */     if (paramType.getSort() == 10 || paramType.getSort() == 9) {
/* 131 */       return String.format("(%sZ%s)V", new Object[] { "Ljava/lang/String;", "Ljava/lang/Object;" });
/*     */     }
/*     */     
/* 134 */     return String.format("(%sZ%s)V", new Object[] { "Ljava/lang/String;", paramType.getDescriptor() });
/*     */   }
/*     */   
...
/* Location:              C:\Users\homy\AppData\Roaming\.minecraft\mods\FogClientV1_cracked.jar!\org\spongepowered\asm\mixin\injection\callback\CallbackInfo.class
