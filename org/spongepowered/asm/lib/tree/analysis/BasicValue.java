...
/*  82 */       return true; 
/*  83 */     if (paramObject instanceof BasicValue) {
/*  84 */       if (this.type == null) {
/*  85 */         return (((BasicValue)paramObject).type == null);
/*     */       }
/*  87 */       return this.type.equals(((BasicValue)paramObject).type);
/*     */     } 
/*     */     
/*  90 */     return false;
/*     */   }
...
/* Location:              C:\Users\homy\AppData\Roaming\.minecraft\mods\FogClientV1_cracked.jar!\org\spongepowered\asm\lib\tree\analysis\BasicValue.class
