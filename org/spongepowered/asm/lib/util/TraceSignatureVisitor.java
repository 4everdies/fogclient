...
/* 201 */     this.declaration.append(paramString);
/* 202 */     endType();
/*     */   }
/*     */ 
/*     */   
...
/* 214 */     if ("java/lang/Object".equals(paramString)) {
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */       
/* 220 */       boolean bool = (this.argumentStack % 2 != 0 || this.seenParameter) ? true : false;
/* 221 */       if (bool) {
/* 222 */         this.declaration.append(this.separator).append(paramString.replace('/', '.'));
/*     */       }
/*     */     } else {
/* 225 */       this.declaration.append(this.separator).append(paramString.replace('/', '.'));
/*     */     } 
/* 227 */     this.separator = "";
...
/* 238 */     this.declaration.append(this.separator).append(paramString.replace('/', '.'));
/* 239 */     this.separator = "";
...
/* Location:              C:\Users\homy\AppData\Roaming\.minecraft\mods\FogClientV1_cracked.jar!\org\spongepowered\asm\li\\util\TraceSignatureVisitor.class
